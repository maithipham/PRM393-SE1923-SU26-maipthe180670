...
class _UserListScreenState extends ConsumerState<UserListScreen> {
  ...
  String? _validateFullName(String? value) {
    ...
    if (value == null || value.isEmpty) return 'Họ và tên không được để trống';
    if (value.length < 2) return 'Họ và tên tối thiểu 2 ký tự';
    return null;
  }
  ...
  String? _validateAvatar(String? value) {
    ...
    if (value == null || value.isEmpty) return 'Vui lòng chọn ảnh đại diện';
    return null;
  }
